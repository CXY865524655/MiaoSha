...
function catchEntitiesFromLocation($entity, $x, $y, $radius){
    $url = "http://api.map.baidu.com/place/v2/search?ak=iZtnwXpdwzhm45Crk8MIBZz9u61DgWlH&output=json&query=".$entity."&page_size=5&page_num=0&scope=2&location=".$x.",".$y."&radius=".$radius."&filter=sort_name:distance";
