...
<HTML>
    ...
    <BODY>
        <script type="text/javascript">
            document.addEventListener('WeixinHSBridgeReady', function onBridgeReady() {
                WeixinHSBridge.call('hideOptionMenu');
            });
            document.addEventListener('WeixinHSBridgeReady', function onBridgeReady() {
                WeixinHSBridge.call('hideToolbar');
            });
        </script>
    <div data-role="page" id="page1">
        <div data-role="content">
            <div style="text-align: center">
                <img style="width: 99%;height: %" src="<?php echo $userinfo[""];?>">
            </div>
